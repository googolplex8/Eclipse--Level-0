...
public class eatMe extends KeyAdapter {
	...
	private void makeAlbum() {
		...
		// this...
		images.put(new Integer(KeyEvent.VK_UP), "pasta.jpg");
		images.put(new Integer(KeyEvent.VK_RIGHT), "meat.jpg");															// be connected
		images.put(new Integer(KeyEvent.VK_DOWN), "soup.jpg");														// to the UP key
		images.put(new Integer(KeyEvent.VK_LEFT), "dumpling.jpg");
...
jFrame.setVisible(true);
	...
	public void keyPressed(KeyEvent e) {
		...
		if (whichKeyPressed == correctUtensilCode){
			...
			System.out.println("Learn some manners!");
			numOfTries-=1;
